...
('Campo Minado', 'Teste sua lógica e sorte. Encontre todos os quadrados vazios sem detonar nenhuma mina escondida.', 'dev/IMG/Site/Cartuchos/cartuchoAzulGoiaba.png', NULL),
('Snake', 'Controle a cobra e coma as maçãs para crescer. Cuidado para não bater nas paredes ou em si mesma!', 'dev/IMG/Site/Cartuchos/cartuchoVermelhin.png', NULL);
