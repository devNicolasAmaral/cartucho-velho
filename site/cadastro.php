...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo DEV_URL ?>CSS/cadastro.css">
    </head>
    <body>
        <div class="container-fluid p-0">
            <div class="row g-0">
                            ...
                            <div class="p-3">
                                ...
                                <form action="dev/exec/login_exec.php" method="POST">
                                    ...
                                    <div class="d-grid div-btn">
                                        <button type="submit" class="btn btn-custom-cadastro btn-pill mt-2">Entrar</button>
                                    </div>
                                </form>
                ...
                <div class="col-md-6 d-none d-md-flex right-panel">
                    <div>
